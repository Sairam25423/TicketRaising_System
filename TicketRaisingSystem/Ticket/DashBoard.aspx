<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DashBoard.aspx.cs" MasterPageFile="~/SubMaster.Master" Inherits="TicketRaisingSystem.Ticket.DashBoard" %>
...
<asp:Content ID="Body" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard</h1><a><i class="fas fa-download fa-sm text-white-50"></i>Generate Report</a>
        </div>
        <!-- Content Row -->
        <div class="row">
